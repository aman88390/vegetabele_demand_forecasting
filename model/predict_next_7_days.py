...
# #         "global_linreg_path": os.path.join(BASE_DIR, "global_models", "fruit_global_linreg.pkl"),
# #         "global_rf_path": os.path.join(BASE_DIR, "global_models", "fruit_global_rf.pkl"),
# #         "item_lr_path": os.path.join(BASE_DIR, "fruit_item_linreg_models.pkl"),
# #         "pred_out": os.path.join(BASE_DIR, "fruit_7day_predictions.csv"),
# #     },
# #     "veg": {
...
# #         "global_linreg_path": os.path.join(BASE_DIR, "global_models", "veg_global_linreg.pkl"),
# #         "global_rf_path": os.path.join(BASE_DIR, "global_models", "veg_global_rf.pkl"),
# #         "item_lr_path": os.path.join(BASE_DIR, "veg_item_linreg_models.pkl"),
# #         "pred_out": os.path.join(BASE_DIR, "veg_7day_predictions.csv"),
# #     },
# # }
...
# #     # last price per item (fallback to global median if something missing)
# #     last_price_per_item = (
# #         df.sort_values("date")
# #           .groupby("item")["price"]
# #           .tail(1)
# #           .reset_index()
# #           .set_index("item")["price"]
# #     )
...
# #         X_raw[col] = 0.0  # categories not present in future
...
# #     # 4. Moving Average baseline (item-wise)
# #     window = 7
# #     ma_preds = []
...
# #     future_raw["pred_moving_avg"] = ma_preds

# #     # 5. Global models (Linear Regression & Random Forest)
# #     global_linreg = joblib.load(cfg["global_linreg_path"])
# #     global_rf = joblib.load(cfg["global_rf_path"])

# #     future_raw["pred_global_linreg"] = global_linreg.predict(X_future)
# #     future_raw["pred_global_rf"] = global_rf.predict(X_future)

# #     # 6. Item-wise Linear Regression models
# #     item_models = joblib.load(cfg["item_lr_path"])
# #     item_lr_preds = []
...
# #         if model is None:
# #             # fallback to global linear regression if this item had no dedicated model
# #             item_lr_preds.append(future_raw.loc[idx, "pred_global_linreg"])
# #         else:
# #             x_row = X_future.loc[[idx]]   # single-row DF
# #             pred_val = model.predict(x_row)[0]
# #             item_lr_preds.append(pred_val)

# #     future_raw["pred_itemwise_linreg"] = item_lr_preds

# #     # 7. Clip + round predictions (no negative demand)
# #     for col in ["pred_moving_avg", "pred_global_linreg", "pred_global_rf", "pred_itemwise_linreg"]:
...
# DATA_CONFIG = {
#     "fruit": {
#         # 👇 make sure this is the CLEAN file, not raw
#         "clean_path": "Data_preprocessing/fruit_sales_clean.csv",
#         "encoder_path": os.path.join(BASE_DIR, "fruit_encoder.pkl"),
#         "scaler_path": os.path.join(BASE_DIR, "fruit_scaler.pkl"),
#         "feature_cols_path": os.path.join(BASE_DIR, "fruit_feature_cols.json"),
...
#         "item_lr_path": os.path.join(BASE_DIR, "fruit_item_linreg_models.pkl"),
#         # "pred_out": os.path.join(BASE_DIR, "fruit_7day_predictions.csv"),
#         "pred_out": ("fruit_7day_predictions.csv"),
...
#         "item_lr_path": os.path.join(BASE_DIR, "veg_item_linreg_models.pkl"),
#         # "pred_out": os.path.join(BASE_DIR, "veg_7day_predictions.csv"),
#         "pred_out": ("veg_7day_predictions.csv"),
#     },
# }
